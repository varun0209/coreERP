...
export class ApiConfigService {
   ...
   // updateLeaveRequests = `${this.environment.runtimeConfig.serverUrl}masters/LeaveTypeMasters/UpdateLeaveTypeMaster`;
   // deleteLeaveRequests = `${this.environment.runtimeConfig.serverUrl}masters/LeaveTypeMasters/DeleteLeaveTypeMaster`;
   ...
   getMemberNamesList = `${this.environment.runtimeConfig.serverUrl}sales/Billing/GetMemberNamesList`;
